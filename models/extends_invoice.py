		...
		if self.type in ['out_invoice','out_refund'] and self.state in ['open','paid'] and self.afip_auth_code != '':
			try:
					dict_invoice = {
							...
							"moneda": self.currency_id.l10n_ar_afip_code,
							"ctz": self.l10n_ar_currency_rate,
							"tipoDocself": int(self.partner_id.l10n_latam_identification_type_id.l10n_ar_afip_code),
							"nroDocRec": int(self.partner_id.vat),
							"tipoCodAut": 'E',
